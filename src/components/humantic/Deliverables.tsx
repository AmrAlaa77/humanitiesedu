        ...
        days: [
          {
            ...
            points: [
              'Uncover the hidden lenses and biases quietly shaping how you see people',
              'See how bias forms long before you notice it',
              'Learn why good intentions don\'t always land the way you meant',
              'Treat diversity as a real pattern, not a slogan',
              'Leave owning the filters behind your own judgment',
            ],
          },
          {
            title: 'Day 2 — "Mind-Read" (Sort Of): Predictable Human Differences',
            points: [
              'Discover why the same feedback lands differently across a room',
              'A first taste of the psychology behind everyday workplace behaviour',
              'Read behavioural signals without judging or over-personalising',
              'People differences follow patterns you can learn to read',
              'Leave with noticeably less friction across teams',
            ],
          },
          {
            title: 'Day 3 — Belonging by Design',
            points: [
              'Learn how your body signals safety before your mind catches up',
              'See how managing your own state changes how safe others feel',
              'Spot small daily habits that build or break trust',
              'Practise staying grounded in real team situations',
              'Leave able to stay steady when the room gets tense',
            ],
          },
          {
            title: 'Day 4 — Interpersonal & Social Fluency',
            points: [
              'Practise giving feedback and holding presence under pressure',
              'Learn a fast reset from reactive to composed in seconds',
              'Rehearsed through realistic boardroom and conflict scenarios',
              'Build the habit of responding rather than reacting',
              'Leave carrying visibly more credibility in the room',
            ],
          },
          {
            title: 'Day 5 — Organizational Savviness',
            points: [
              'Learn to read the unspoken cues and power dynamics in any room',
              'Pick up on office social cues and respond with composed presence',
              'Lock the habit in with months of ongoing peer practice',
              'Leave with a personal roadmap for your first 100 days',
              'Walk in on day one with your own readiness plan',
            ],
          },
        ],
        benefitsLabel: 'Programme objectives',
        benefits: [
          'Make professional excellence feel instinctive, not performed',
          'Stay steady and get it right the first time, under pressure',
          'Stop guessing workplace dynamics and start reading people accurately',
          'Turn psychological safety from a buzzword into something real',
          'Skip most of the usual rookie learning curve',
        ],
        ...
        days: [
          {
            ...
            points: [
              'A gamified simulation of real day-to-day operations, outdoors',
              'A safe space where mistakes cost a debrief, not millions',
              'Composure and talent-spotting measured against world-class standards',
              'Built from two decades of real industry partnership insight',
              'A high-energy leadership flight simulator, not a lecture',
            ],
          },
          {
            title: 'Day 2 — Indoors Experientials (3 hours) + Focus Group (2 hours)',
            points: [
              'Fast, real-time huddles that turn every task into a lesson',
              'A peer focus group to consolidate the day\'s insights',
              'A mirror for leaders to see what enables or blocks change',
              'Built on live dialogue, not information sessions',
              'Leave energised and aligned around a shared leadership charter',
            ],
          },
        ],
        benefitsLabel: "What we're watching for — the Fortune 500 stress test",
        benefits: [
          'How people communicate, or go quiet, when pressure rises',
          'Whether people own failure or explain it away',
          'How well composure holds up when the room gets tense',
          'How tone shifts as stress builds through the day',
          'Whether people freeze or keep momentum when the answer isn\'t clear',
        ],
        ...
        days: [
          {
            ...
            points: [
              ...
              'Saudi trainers pass on wellbeing fundamentals to their peers',
              'Grounded in the same youth-fluent approach used across the initiative',
              'The first of four steps, ahead of the VR workshops',
            ],
          },
          {
            title: 'Step 2 — VR Visionaries: Virtual Reality Wellness Workshop',
            points: [
              'Visualise the inner wellness journey, one simulation at a time',
              'An immersive experience that makes wellbeing feel real, not abstract',
              'Reframes how you perceive and manage stress in the moment',
              'Builds a felt sense of the brain-body connection',
            ],
          },
          {
            title: 'Step 3 — VR Realities: Neuroscience-Based Workshop',
            points: [
              'Goes deeper, with guided mentoring through the wellness journey',
              'Makes brain and body science personal and easy to grasp',
              'Learn by doing, through gamified, hands-on exploration',
              'Closes with a personal wellbeing plan and 3-month follow-up',
            ],
          },
          {
            title: 'Step 4 — The Power of Togetherness',
            points: [
              'A parents\' workshop, co-creating wellness as a family',
              'Parents grasp the basics of adolescent mind and body development',
              'Family collaboration around a shared, personalised wellbeing plan',
              'Sets collaborative goals for a supportive home environment',
            ],
          },
        ],
        ...
        days: [
          {
            ...
            points: [
              'Grounded in strengths-based research, not guesswork',
              'Helps leaders unlock the strengths already inside their teams',
              'Shifts the focus from fixing deficits to building on strengths',
              'Helps people embrace and celebrate what makes them unique',
            ],
          },
          {
            title: 'Module 2 — Sustaining Collective Strength: Derailers One-on-Ones',
            points: [
              'Maps how individual strengths combine into real team synergy',
              'Team members learn to actively lean on each other\'s strengths',
              'A confidential one-on-one debrief on what dims a strength',
              'Helps each person realise their true potential, not just perform',
            ],
          },
        ],
        ...
        days: [
          {
            title: 'Discovery',
            points: [
              'A confidential one-on-one to find your real starting line',
              'A private space to explore your own wiring, honestly',
              'Uncovers the internal barriers most likely blocking your impact',
              'A safe space to name both strengths and vulnerabilities',
            ],
          },
          {
            title: 'Immersion',
            points: [
              'Peer focus groups for shared, real-world modelling',
              'Co-creates strategies built specifically around you',
              'Surfaces emotional triggers before they turn into derailers',
              'Builds directly on what Discovery uncovered',
            ],
          },
          {
            title: 'Integration',
            points: [
              'A month of mentoring to move from knowing to doing',
              'Turns behaviour patterns into deeper self-insight',
              'Lifts both individual performance and team execution',
              'Sustained support, not a single one-off session',
            ],
          },
          {
            title: 'Audit',
            points: [
              'Checks whether real change actually happened',
              'Confirms internal shifts translated into leadership behaviour',
              'Closes the loop on the whole journey',
              'Measures the return on a month of mentoring',
            ],
          },
        ],
        benefitsLabel: 'What you leave with',
        ...
        days: [
          {
            title: 'Mind Clearing',
            points: [
              'Practical ways to capture thoughts and clear mental clutter',
              'Simple techniques for creating and prioritising tasks',
              'Learn how the body signals stress before the mind notices',
              'Learn to pause and respond, instead of reacting on impulse',
            ],
          },
          {
            title: 'Project Management Principles',
            points: [
              'Get set up on a shared digital organisational tool',
              'Create and organise tasks tied to real projects',
              'Set due dates and clear ownership',
              'Track progress in one place, without lost threads or sticky notes',
            ],
          },
          {
            title: 'Wellness Integration',
            points: [
              'Connect a clear mind to lower everyday stress',
              'Set a personal goal for using the new habits',
              'Learn to guide progress instead of hovering over it',
              'Build the space for teams to thrive without micromanagement',
            ],
          },
        ],
        benefitsLabel: 'What you leave with',
    ...
    items: [
      ...
      },
      {
        ...
        benefits: [
          ...
          'Grounded in a proprietary blend of behavioural science, summarised into one practical overview',
        ],
    ...
    items: [
      {
        ...
        days: [
          {
            ...
            points: [
              'Starts with a real read on your culture and needs',
              'A baseline check before anything is customised',
          ...
          },
          {
            ...
            points: [
              'A focus group keeps the programme grounded in reality',
              'One-on-one sessions to make it personal',
              'A month of ongoing mentoring, not a single session',
            ],
          },
          {
            title: 'Phase 03 — Productivity',
            points: [
              'Regular check-ins keep the habits sticking',
              'A recognition thread that celebrates real progress',
              'AI tools supporting mental clarity and daily priorities',
              'Hands-on, immersive practice, not passive listening',
            ],
          },
          {
            title: 'Phase 04 — Happiness & Loyalty',
            points: [
              'Team retreats and wellness champions worth celebrating',
              'Immersive wellbeing sessions that stay memorable',
              'Culture and individual progress tracked over time',
              'Gamified check-ins that make learning feel light',
            ],
          },
        ],
        ...
        benefits: [
          'A real read on the hidden barriers to your influence',
          'Leadership built on strengths, not just fixing gaps',
          'Practical trust and psychological safety between people',
          'Decision-making insight for when the pressure is on',
          'A direct look at what stress and procrastination cost you',
        ],
      ...
      },
      {
        ...
        benefits: [
          'A personalised report on your own tendencies and root causes',
          'Delivered through a confidential one-on-one debrief',
          'Shares its DNA with a framework used across our other initiatives',
          'Helps you build on strengths instead of fixating on gaps',
        ],
      ...
      },
      {
        ...
        benefits: [
          'Most firms are stuck paying to re-teach the same lessons',
          'Old habits quietly resist being overwritten by new training',
          'A short motivation spike usually collapses back to baseline',
          'Uses neural plasticity to make excellence the default, not an effort',
          'Turns a temporary boost into lasting, built-in performance',
        ],
...
const initiatives: Record<string, Initiative> = {
  ...
  orgs: {
    ...
    featuresLabel: 'The business case for people-first culture',
    features: [
