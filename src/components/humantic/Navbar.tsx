    ...
    >
      ...
      >
        ...
        <nav className="hidden md:flex items-center gap-7">
          ...
          <Link to="/nextgen-2030" className="text-sm font-medium text-slate-300 hover:text-white transition">
            NextGen 2030
          </Link>
      ...
      >
        <div className="px-5 py-4 space-y-3">
          ...
          <Link to="/nextgen-2030" onClick={() => setOpen(false)} className="block w-full text-left py-1.5 text-slate-200">
            NextGen 2030
          </Link>
