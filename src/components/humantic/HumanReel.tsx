...
const HumanReel: React.FC = () => {
  ...
  return (
    <section id="top" className="relative flex min-h-[100svh] w-full flex-col justify-between overflow-hidden bg-[#0f172a] text-white">
      ...
      <div className="relative z-10 flex flex-1 items-center justify-center overflow-x-visible overflow-y-hidden px-2">
        ...
        >
          ...
          <div
            ...
            style={{ height: '9%', background: 'linear-gradient(to bottom, #0f172a 0%, #0f172a 55%, transparent 100%)' }}
          />
          <div
            className="pointer-events-none absolute inset-x-0 bottom-0 h-6"
            style={{ background: 'linear-gradient(to top, #0f172a 0%, #0f172a 35%, transparent 100%)' }}
          />
          ...
          <div
            ...
            style={{ background: 'linear-gradient(to right, #0f172a 0%, #0f172a 35%, transparent 100%)' }}
          />
          <div
            className="pointer-events-none absolute inset-y-0 right-0 w-6"
            style={{ background: 'linear-gradient(to left, #0f172a 0%, #0f172a 35%, transparent 100%)' }}
          />
        </div>
      </div>
