...
/**
 * Minimal teaser standing in for the UN Habitat Quality of Life section on the homepage -- the
 * full detail now lives on its own page at /qol-2030 ("QoL 2030 Initiative"). Same style/pattern
 * as ExperienceLink/FounderLink/JourneyLink.
 */
const QualityOfLifeLink: React.FC = () => {
...
export default QualityOfLifeLink;
