...
const stats = [
  ...
  { value: '20,000', label: 'Semi/fully funded certifications exclusive for GCC nationals, 2023–2026' },
];
...
const Founder: React.FC = () => {
  ...
  <section id="founder" className="relative py-24 overflow-hidden">
    <div className="max-w-7xl mx-auto px-5 sm:px-8">
      ...
      {/* 15 Markets across 5 continents — just the country list, closing out the bio. */}
      <div className="mt-10">
