...
/**
 * Minimal teaser standing in for the AwarenessJourney section on the homepage -- the full
 * two-step story (Hybrid Awareness Classes, A Wearable That Understands You) now lives on the
 * AURION ONE page, since it's the wearable this content is actually describing. Same
 * style/pattern as HeroLink/QualityOfLifeLink/JourneyLink.
 */
const AwarenessJourneyLink: React.FC = () => {
      ...
      <div className="relative flex flex-col gap-6">
        <div>
          ...
          <h3 className="mt-3 text-2xl sm:text-4xl font-bold text-white tracking-tight">
            Technology built to feel human
          </h3>
          <p className="mt-3 text-slate-400 leading-relaxed">
            Decoding how the body copes and the mind works, in language everyone can understand
            &mdash; from awareness classes to a wearable that understands you.
          </p>
        </div>
...
export default AwarenessJourneyLink;
