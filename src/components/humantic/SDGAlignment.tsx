  ...
  <section id="sdg-alignment" className="relative py-24">
    <div className="max-w-7xl mx-auto px-5 sm:px-8">
      ...
      <div className="mt-8 grid grid-cols-2 sm:grid-cols-3 gap-3 max-w-2xl">
        {sdgTiles.map((s) => (
          <div key={s.num} className={`${s.color} rounded-xl p-4 aspect-square flex flex-col justify-between`}>
      ...
      <div className="mt-8 rounded-2xl border border-white/10 bg-white/[0.04] p-8 max-w-3xl">
      ...
      <div className="mt-5 grid sm:grid-cols-2 gap-x-10 gap-y-3 max-w-3xl">
        {sdohActions.map((a) => (
