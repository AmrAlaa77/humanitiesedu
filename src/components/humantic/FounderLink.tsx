...
/**
 * A minimal teaser standing in for the full Founder section on the homepage -- the detailed
 * bio, stats, credentials and partner rail now live on their own page at /founder. Matches the
 * "minimal text, click through for detail" pattern used elsewhere on the site (ExperienceLink,
 * the Deliverables + toggles).
 */
const FounderLink: React.FC = () => {
          ...
          <div className="relative flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <p className="mt-3 text-slate-400 max-w-lg leading-relaxed">
                Medical Doctor &middot; Investor &middot; C-Suite Executive &mdash; 17 years building
                Humantic Digital across 15+ markets and 120+ organisations.
              </p>
            </div>
